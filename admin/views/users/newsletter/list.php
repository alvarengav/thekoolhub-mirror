  ...
  <div class="widget-app-table-list">
    <div class="row page-title-row">
      ...
      <? if($this->MApp->secure->edit && $this->model->mconfig['new-element']):?>
        ...
        <? endif ?>
        <a class="btn btn-success pull-right" download="Newsletters" target="_blank" style="margin-right:10px" href="<?= base_url() . "{$appController}/export_newsletter" ?>"><?= $this->lang->line("Descargar EXCEL") ?></a>
      </div>
    </div>
