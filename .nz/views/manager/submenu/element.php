...
<? $field = 'id_menu'; unset($select['SelectMenu']['']); $this->load->view('app/form', array('item' => array(
    'type' => 'select',
    'columns' => 2,
    'form' => $wgetId,
    'name' => $field,
...
<? $field = 'num'; $this->load->view('app/form', array('item' => array(
  ...
  <? $field = 'root'; $this->load->view('app/form', array('item' => array(
    'columns' => 2,
    'type' => 'checkbox',
    'form' => $wgetId,
    'name' => $field,
    'label' => $this->lang->line('Requiere Root'),
    'value' => $field,
    'error' => $this->validation->error($field),
    'class' => $this->validation->error_class($field),
