...
var DataTableFn = function(){
  ...
  configDT.aoColumns = [
    ...
    { "sTitle": "<?= $this->lang->line("Nombre") ?>", "mData": "ico", "sType": "string"},
    { "sTitle": "<?= $this->lang->line("Clase") ?>", "mData": "class", "sType": "html", "mRender" : function( data, type, full ){
    ...
    { "sTitle": "<?= $this->lang->line("Ícono") ?>", "mData": "class", "sClass": "text-align-center", "sType": "html", "mRender" : function( data, type, full ){
    	if(data.indexOf('material-icons') == -1)
      	return '<span class="nav-ico-list"><i class="nav-ico '+ data +'"></i></span>';
    	return '<span class="nav-ico-list">'+ data +'</span>';
    }},
