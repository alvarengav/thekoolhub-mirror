    ...
    <div class="widget-form-content">
      ...
      <div class="well-white smart-form">
        ...
        <header class="title-form">Encabezados</header>
          ...
          <header class="title-form">Projectos</header>
          <div class="col-md-12 col">
            <br>
            <a href="<?= base_url() ?>contents/projects" class="btn btn-primary" target="_blank"><i class="fa fa-arrow-right"></i> Agregar nuevo o editar</a>
            <br>
            <br>
          </div>
