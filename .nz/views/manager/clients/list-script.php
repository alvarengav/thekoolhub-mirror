...
var DataTableFn = function(){
  ...
  configDT.aoColumns = [
    ...
    { "sTitle": "<?= $this->lang->line("Cliente") ?>", "mData": "client", "sType": "string"},
    ...
    { "sClass": "text-align-center", "sWidth": "50px", "sTitle": "<?= $this->lang->line("Empresas") ?>", "mData": "companies", "sType": "string"},
