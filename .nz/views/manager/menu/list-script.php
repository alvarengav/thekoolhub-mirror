...
var DataTableFn = function(){
  ...
  configDT.fnServerParams = function ( aoData ) {
    aoData.push( { "name": "filter-id_ico", "value": $('#id_icoFormSelect<?= $wgetId ?>').val() } );
  ...
  configDT.aoColumns = [
    ...
    { "sTitle": "<?= $this->lang->line("Controlador") ?>", "mData": "controller", "sType": "string"},
    { "sTitle": "<?= $this->lang->line("Nombre") ?>", "mData": "name", "sType": "string"},
    { "sTitle": "<?= $this->lang->line("Ícono") ?>", "mData": "ico", "sType": "string"},
    { "sTitle": "<?= $this->lang->line("Orden") ?>", "sClass": "text-align-center", "sWidth": "40px", "mData": "num", "sType": "string"},
