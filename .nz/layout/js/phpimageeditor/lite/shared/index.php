							...
							<div id="panel_<?php PIE_Echo(PIE_MENU_CROP); ?>" class="panel">
								...
								<div class="field crop-settings">
									<div class="crop-top">
										...
										<? if(isset($_GET['sizeX']) && $_GET['sizeX'] && isset($_GET['sizeY']) && $_GET['sizeY']): ?>
										<span style="margin-left:20px">| <span style="margin-left:15px">Ancho recorte web: <span id="cropwidth"><?= $_GET['sizeX'] ?></span>
										Alto recorte web: <span id="cropheight"><?= $_GET['sizeY'] ?></span></span></span>
									<? endif ?>
									</div>
									...
									<? if(isset($_GET['sizeX']) && $_GET['sizeX'] && isset($_GET['sizeY']) && $_GET['sizeY']): ?>
									<input id="cropwsizex" type="hidden" name="" value="<?= ($_GET['sizeX']); ?>"/>			
									<input id="cropwsizey" type="hidden" name="" value="<?= ($_GET['sizeY']); ?>"/>			
									<input style="margin-left:20px" type="button" id="btncropweb" name="" value="Aplicar recorte para web">						
									<? endif ?>
								</div>
							</div>
