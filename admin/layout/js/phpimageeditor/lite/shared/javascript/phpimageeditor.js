...
function phpimageeditor_init()
{
    ...
    $("#btncropweb").click(function()
    {
    	var sizeX = $('#cropwsizex').val();
    	var sizeY = $('#cropwsizey').val();
    	objCrop.enable();
    	set_crop_values({x:0,y:0,w:sizeX,h:sizeY});
    	objCrop.setSelect([0,0,sizeX,sizeY]);
    	$("#cropkeepproportions").prop('checked', false).click();
    });
