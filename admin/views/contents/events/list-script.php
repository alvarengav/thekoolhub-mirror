...
var DataTableFn = function(){
  ...
  configDT.aoColumns = [
    ...
    // { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("IdiomaIdioma") ?>", "mData": "lang", "sType": "string"},
    ...
    // }},
    // { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Num") ?>", "mData": "num", "sType": "string"},
    { "sClass": "text-align-center", "sWidth": "40px", "sTitle": "<?= $this->lang->line("Esatdo") ?>", "mData": "active", "sType": "html", "mRender" : function( data, type, full ){ 
