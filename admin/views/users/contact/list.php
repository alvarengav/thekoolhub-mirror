...
<div id="main">
  <div class="widget-app-table-list">
    <div class="row page-title-row">
      ...
      <? endif ?>
      <a class="btn btn-success pull-right" download="Contactos" target="_blank" style="margin-right:10px" href="<?= base_url() . "{$appController}/export_contacts" ?>"><?= $this->lang->line("Descargar EXCEL") ?></a>
