...
var DataTableFn = function(){
  ...
  configDT.aoColumns = [
    ...
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Edad") ?>", "mData": "age", "sType": "string"},
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("País") ?>", "mData": "country", "sType": "string"},
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Club") ?>", "mData": "club", "sType": "string"},
    // { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Newsletter") ?>", "mData": "newsletter", "sType": "string"},
    // { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Avísame/Infórmame") ?>", "mData": "type", "sType": "string"},
