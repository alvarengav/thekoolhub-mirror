...
var DataTableFn = function(){
  ...
  configDT.fnServerParams = function ( aoData ) {
    aoData.push( { "name": "filter-id_blog", "value": $('#id_blogFormSelect<?= $wgetId ?>').val() } );
  ...
  configDT.aoColumns = [
    ...
    { "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Fecha") ?>", "mData": "date", "sType": "string"},
    { "bVisible": false, "sClass": "text-align-center", "sTitle": "<?= $this->lang->line("Share_instagram") ?>", "mData": "share_instagram", "sType": "string"},
