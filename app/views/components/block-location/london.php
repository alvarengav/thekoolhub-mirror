<div class="map-container wow2 w2FadeIn" data-wow2-delay="300">
    <div class="map-details">
        <div class="center">
            <div class="center2">
                ...
                <div class="text"><?= $this->Data->Content('map-location-text-london') ?></div>
                <div class="text2"><?= $this->Data->Content('map-location-address-london') ?></div>
                <hr>
                <div class="phone"><?= $this->Data->Content('phone-london') ?></div>
            </div>
        </div>
    </div>
    <div id="map"></div>
    <script type="text/javascript"
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAxsmkXnzCYIiYrcD6QMW2zNqI8U_VuBSk"></script>
    <script type="text/javascript">
    ...
    function init() {
        var mapOptions = {
            ...
            center: new google.maps.LatLng(51.544320, -0.023626),
            styles: [{
